...
import os
current_dir = os.path.dirname(os.path.abspath(__file__))   # py_code 目录
project_dir = os.path.dirname(current_dir)                # project 目录

parser.add_argument('--base_feat_path', type=str, default=os.path.join(project_dir, "feat", "baseFeat.pkl"))
parser.add_argument('--w2v_load_path', type=str, default=os.path.join(project_dir, "w2v_models")) 
...
parser.add_argument('--save_path',  type=str, default="feat/baseFeat1.pkl")
