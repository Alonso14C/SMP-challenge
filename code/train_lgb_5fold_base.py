...
def make_model(args, n_estimators=None):
    return lgb.LGBMRegressor(
        ...
        max_depth=5,
        learning_rate=0.03,
        n_estimators=int(n_estimators or args.lgb_n_estimators),
...
def main():
    ...
    parser.add_argument('--lgb_n_estimators', type=int, default=25000)
    parser.add_argument('--lgb_n_jobs', type=int, default=20)
    ...
    parser.add_argument('--tag', default='lgb_base_5fold_oldclip_3000')
    ...
    raw_path = os.path.join(args.output_dir, f'sub_lgb.csv')
